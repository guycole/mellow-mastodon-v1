...
class MastodonApp:
    ...
    def __init__(self, score_limit, stunt_box: str):
        ...
        # wombat docker
        self.db_conn = "postgresql+psycopg2://mastodon_client:batabat@172.17.0.1:5432/mastodon"

        # mac development
        # self.db_conn = "postgresql+psycopg2://mastodon_client:batabat@localhost:5432/mastodon"
...
if __name__ == "__main__":
    ...
    app = MastodonApp(int(score_limit), stunt_box)
    app.execute()
